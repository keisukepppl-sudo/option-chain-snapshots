# Morita Unified Flow v3.8 Main Report
...
0 non-unavailable rows. State machine replayed, all rows remain BAND_UNAVAILABLE.
...
HIGHEST MILESTONE:
M1_REGISTRY_SCHEMA_ACTIVATED

REMAINING BLOCKER:
PIT V_t remains incomplete: guidance/capital-structure/reference-rate fields unavailable in local official evidence layer.
...
- 3. Local official source count: 7
...
- 16. valid absorption rows: 0
- 17. true intraday rows: 0
- 18. daily proxy rows: 978
...
- 55. S=309/A=504: 309/504 reconciled
- 56. threshold optimization: No
- 57. options: No
- 58. broker/account access: No
- 59. production changed: No
- 60. future info: False
- 61. highest milestone: M1_REGISTRY_SCHEMA_ACTIVATED
- 62. largest remaining blocker: PIT V_t remains incomplete: guidance/capital-structure/reference-rate fields unavailable in local official evidence layer.
